export default function People() {
  return (
    <>
      <h1 className="head">PEOPLE I ADMIRE</h1>

      <div className="peopleContainer"><div className="quoteContainer">
        <p>
        Those you cannot meet are neither to love nor hate; they are simply lessons to learn.        </p>
        <p>― Written By Me</p>
      </div>
        <div className="people">
          ...
          ><p>Be — don't try to become</p></div>
          <div
            className="peopleCard"
            style={{
              backgroundImage:
          ...
          ><p>When you have something to say, silence is a lie.</p></div>
          <div
            className="peopleCard"
            style={{
              backgroundImage:
